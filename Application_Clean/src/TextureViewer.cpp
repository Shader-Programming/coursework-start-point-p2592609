...
{
	m_colShader.reset(new Shader("..\\Shaders\\textureViewerVert.glsl", "..\\Shaders\\textureViewerFrag.glsl"));
	createQuadVAO();
}

void TextureViewer::drawColourTexture(unsigned int texID)
{
...
void TextureViewer::createQuadVAO()
{
	//create buffers
